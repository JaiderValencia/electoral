    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-12">
                                            <div class="input-group" id="corregimiento-group">
                                                <div class="input-group-addon"><i class="fa-solid fa-map-location-dot"></i>
                                                </div>
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-12">
                                            <div class="input-group" id="barrio-group">
                                                <div class="input-group-addon"><i class="fa-solid fa-location-arrow"></i>
                                                </div>
                ...
                <form method="get" action="{{route('votantes.listado')}}" id="buscador" class="d-flex mb-3 mt-3">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ route('votantes.editar', $votante->id) }}"
                                                                ...
                                                                <div class="col col-md-12">
                                                                    <div class="input-group"
                                                                        ...
                                                                        <select name="municipio" id="municipio-{{$votante->id}}"
                                                                            ...
                                                                            <option selected disabled>Municipio</option>
                                                                            @foreach ($municipios as $municipio)
                                                                                <option {{$idSelected == $municipio->id ? "selected" : null}} value="{{ $municipio->id }}">
                                                                                    {{ $municipio->nombre }}
                                                                                </option>
                                                                            @endforeach
                                                                        </select>
                                                            ...
                                                            <div class="row form-group">
                                                                <div class="col col-md-12">
                                                                    <div class="input-group"
                                                                        id="corregimiento-group-{{$votante->id}}">
                                                                        <div class="input-group-addon"><i
                                                            ...
                                                            <div class="row form-group">
                                                                <div class="col col-md-12">
                                                                    <div class="input-group"
                                                                        id="recomendacion-group-{{$votante->id}}">
                                                                        <div class="input-group-addon"><i
