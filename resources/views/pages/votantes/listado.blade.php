                    ...
                    <table id="bootstrap-data-table" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-nowrap text-center">{{ $votante->recomendacion ?? "Ninguno"}}</td>
                                                        ...
                                                        <div class="row form-group">
                                                            <div class="col col-md-12">
                                                                <div class="input-group" id="cedula-group">
                                                                    ...
                                                                    <input type="text" maxlength="255" id="cedulaEditar-{{$votante->id}}"
                                                        ...
                                                        <div class="row form-group">
                                                            <div class="col col-md-12">
                                                                <div class="input-group" id="nombre-group">
                                                                    ...
                                                                    <input type="text" maxlength="255" id="nombre"
                                                        ...
                                                        <div class="row form-group">
                                                            <div class="col col-md-12">
                                                                <div class="input-group" id="corregimiento-group">
                                                                    ...
                                                                    <select name="corregimiento" id="corregimiento"
                                                                        class="{{$hayErrorCorregimiento ? "is-invalid" : ""}} form-control"
                                                                        data-corregimiento-id="{{$votante->corregimiento_id}}">
                                                                        <option selected disabled>Corregimiento</option>
                                                                    </select>
                                                                </div>
                                                                @if ($hayErrorCorregimiento)
                                                        ...
                                                        <div class="row form-group">
                                                            <div class="col col-md-12">
                                                                <div class="input-group" id="barrio-group">
                                                                    ...
                                                                    <select name="barrio" id="barrio"
                                                                        class="{{$hayErrorBarrio ? "is-invalid" : ""}} form-control">
                                                                        <option selected disabled>Barrio</option>
                                                                    </select>
                                                                </div>
                                                                @if ($hayErrorBarrio)
                                                        ...
                                                        <div class="row form-group">
                                                            <div class="col col-md-12">
                                                                <div class="input-group" id="puesto-group">
                                                                    ...
                                                                    <select name="puesto" id="puesto"
                                                                        class="{{$hayErrorPuesto ? "is-invalid" : ""}} form-control">
                                                        ...
                                                        <div class="row form-group">
                                                            <div class="col col-md-12">
                                                                <div class="input-group" id="mesa-group">
                                                                    ...
                                                                    <select name="mesa" id="mesa"
                                                                        class="{{$hayErrorMesa ? "is-invalid" : ""}} form-control">
                                                                        <option selected disabled>Mesa de votación</option>
                                                                    </select>
                                                                </div>
                                                                @if ($hayErrorMesa)
                                                        ...
                                                        <div class="row form-group">
                                                            <div class="col col-md-12">
                                                                <div class="input-group" id="recomendacion-group">
                                                                    ...
                                                                    <input type="text"
                                                                        maxlength="255" id="recomendacion"
                                                                        name="recomendacion"
